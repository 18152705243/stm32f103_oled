...
const unsigned char bmp_edge_falling[] = {
    0x00, 0x02, 0x0a, 0x7e, 0x50, 0x40, 0x00};
...
const unsigned char bmp_frequence[] = {
    0x81, 0x00, 0x7E, 0x12, 0x12, 0x12, 0x00, 0x81};

const unsigned char bmp_duty[] = {
    0x81, 0x00, 0x7E, 0x42, 0x42, 0x22, 0x1C, 0x81};

const unsigned char bmp_beacon_adown[] = {
    0x01, 0x03, 0x07, 0x03, 0x01};

const unsigned char bmp_progress_rect[] = {
